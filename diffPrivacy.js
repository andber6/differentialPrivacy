// Run with command: node diffPrivacy.js
...
// Try making the populations larger. What happens to the accuracy of the
...
(2 * total) / (numPeople + numDogs) - 0.25;
total / numPeople - 0.25;
